        ...
        <div class="row">
          ...
          ?>
            <div class="dropdown d-inline ">
                <a class="btn select dropdown-toggle lh-sm" href="dashboard.php" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" style="text-align:left;"><?php echo"@".$record_profile_signup["username"].""; ?> <br> $ <?php echo $money_earned;?> USD</a>

  ...
  <body>
    <div class='container-fluid mt-5'>
        <div class='row'>
            ...
            <div class='col-sm-5'><img src='images/hiw-page2.webp
                ' alt='' class='img-fluid'></div>
            <div class='col-sm-5'>
                <h1 class='fw-bold'>How do I get started?</h1>
                <h4 class='mt-5'>1. Complete your profile</h4><p class='mt-3'>Simply post a project or contest for what you need done and receive competitive bids from freelancers within minutes.</p>
                ...
                <a href='post-a-project.html' class='btn btn-danger text-center mt-4 ps-5 pe-5' style='border-radius: 0;'>Post a Project</a>
            </div>
            <div class='col-1 d-none d-md-block'></div>
        </div>
        <div class='row mt-5'>

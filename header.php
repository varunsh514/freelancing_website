  ...
  ?>
    ...
    <div class="container-fluid text-center pt-4">
        <div class="row">
          ...
          d-sm-none d-md-block mt-3 zoom"><a href="How-it-works.php" class="text-dark"><span class="select" >How it Works</span></a></div>
          <div class="col d-none d-sm-block
          d-sm-none d-md-block mt-3 zoom"><a href="browsejobs.php" class="text-dark"><span class="select">Browse Jobs</span></a></div>
          <div class="col-2"></div>
          <div class="col mt-3 zoom"><a href="login.php" class="text-dark"><span class="select">Log In</span></a></div>
          <div class="col mt-3 zoom"><a href="signup.php"  class="text-dark "><span class="select">Sign Up</span></a></div>
...
<!--Nav bar starts-->
<div class="nav overflow-auto mt-3 ">

        ...
        <div class="row">
          ...
          <img src='freelance_uploads/<?php echo"".$record["user_profile_photo"]."";?>' class='img-fluid' style='height:40px;width:40px;'>
            ...
            <div class="dropdown d-inline ">
                <a class="btn select dropdown-toggle lh-sm" href="dashboard.php" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" style="text-align:left;"><?php echo"@".$record2["username"].""; ?> <br> $ <?php echo $money_earned;?> USD</a>

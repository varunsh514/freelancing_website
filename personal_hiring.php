                ...
                <div class="col rounded shadow" style="background-color: white;">
                    <div class="row ">
                        ...
                        <div class="col-8">
                            ...
                            <div class="row">
                                <p><span class="text-success fw-bold">N/A</span> <span class="ms-3">Jobs
                                        completed</span></p>
                            </div>
                            <div class="row">
                                <p>
                ...
                <div class="col-3 ms-5 bg-dark rounded shadow pb-3">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea name="" id="" rows="1" class='form-control'>Project for <?php echo "".$record["user_first_name"]." ".$record["user_last_name"]."";?></textarea>
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            <a href="" class='btn btn-primary form-control fw-bold'>Hire <?php echo "".$record["user_first_name"]." ".$record["user_last_name"]."";?></a>
                        </div>
                    </div>

                    <div class="row mt-4">
                        <div class="col text-center">
                            <span class='text-white'>By clicking Hire Username, you have read and agreed to our <a href="" class='text-white fw-bold select'>Terms & Conditions</a> and <a href="" class='text-white fw-bold select'>Privacy Policy</a>.</span>
                        </div>
                    </div>
                </div>
                <div class="col-1"></div>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="ps-3 pb-3 shadow rounded">
                <div class="row">
